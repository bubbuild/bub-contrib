...
| [`packages/bub-workflow`](./packages/bub-workflow/README.md)                         | `workflow`             | Provides template-first bee workflow tools backed by APScheduler, Bub subagents, Bub tape, and workspace projections.                                |
