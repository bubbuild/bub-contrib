...
| [`packages/bub-pages`](./packages/bub-pages/README.md)                               | `pages`                | Manages language-agnostic multi-site static pages with `bub pages` CLI commands to list, add, remove, publish, and serve sites.                     |
