...
KNOWN_OPENAPI_ERRORS: dict[int, QQKnownOpenAPIError] = {
    ...
    11252: _e(
        11252, "ErrorCheckAppPrivilegeFailed", "检查应用权限失败", "permission", True
    ),
    11253: _e(
        11253,
    ...
    11273: _e(
        11273,
        "ErrorCheckUserAuth",
        "当前接口不支持使用 Bearer Token 调用",
        "auth",
        False,
    ),
    11274: _e(
        11274, "ErrorUserAuthNotPass", "用户 OAuth 授权权限未通过", "permission", False
    ),
    11275: _e(11275, "ErrorWrongAppid", "无 appid", "auth", False),
    11281: _e(
        11281, "ErrorCheckAdminFailed", "检查是否是管理员失败", "permission", True
    ),
    ...
    20028: _e(
        20028, "ChannelHitWriteRateLimit", "子频道消息触发限频", "rate_limit", True
    ),
    ...
    50037: _e(
        50037,
        "MarkdownKeyboardOnly",
        "带有 markdown 消息只支持 markdown 或 keyboard 组合",
        "request",
        False,
    ),
    ...
    50047: _e(
        50047,
        "NotBotOrAtBotMessage",
        "非机器人产生的消息或者 at 机器人消息",
        "reply",
        False,
    ),
    ...
    50049: _e(
        50049,
        "KeyboardOnlyEditable",
        "只能修改含有 keyboard 元素的消息",
        "edit_message",
        False,
    ),
    50050: _e(
        50050,
        "KeyboardRequiredWhenEditing",
        "修改消息时 keyboard 元素不能为空",
        "edit_message",
        False,
    ),
    50051: _e(
        50051,
        "OnlyOwnMessageEditable",
        "只能修改机器人自己发送的消息",
        "edit_message",
        False,
    ),
    ...
    50054: _e(
        50054, "MarkdownTemplateParamError", "markdown 模版参数错误", "request", False
    ),
    50055: _e(
        50055, "InvalidMarkdownContent", "无效的 markdown content", "request", False
    ),
    50056: _e(
        50056,
    ...
    50057: _e(
        50057,
        "MarkdownModeConflict",
        "markdown 参数只支持原生语法或者模版二选一",
        "request",
        False,
    ),
    40054005: _e(
    ...
    301000: _e(
        301000, "ChannelPermissionParamInvalid", "参数错误", "channel_permission", False
    ),
    301001: _e(
        301001,
        "ChannelPermissionQueryGuildError",
        "查询频道信息错误",
        "channel_permission",
        True,
    ),
    ...
    301006: _e(
        301006,
        "NonMemberNoPermission",
        "非群成员没有查询权限",
        "channel_permission",
        False,
    ),
    301007: _e(
        301007, "ParamOverLimit", "参数超过数量限制", "channel_permission", False
    ),
    ...
    302007: _e(
        302007, "ScheduleCreatorInfoFailed", "获取创建者信息失败", "schedule", True
    ),
    302008: _e(302008, "ChannelIdRequired", "子频道 ID 不能为空", "schedule", False),
    302009: _e(302009, "ScheduleSystemError", "频道系统错误", "schedule", True),
    302010: _e(
        302010, "SchedulePermissionDenied", "暂无修改日程权限", "schedule", False
    ),
    302011: _e(302011, "ScheduleDeleted", "日程活动已被删除", "schedule", False),
    302012: _e(
        302012, "ScheduleDailyLimit", "每天只能创建 10 个日程", "schedule", False
    ),
    302013: _e(
        302013, "ScheduleSafetyBlocked", "创建日程触发安全打击", "schedule", False
    ),
    302014: _e(302014, "ScheduleTooLong", "日程持续时间超过 7 天", "schedule", False),
    302015: _e(
        302015, "ScheduleStartTooEarly", "开始时间不能早于当前时间", "schedule", False
    ),
    302016: _e(
        302016, "ScheduleEndTooEarly", "结束时间不能早于开始时间", "schedule", False
    ),
    302017: _e(302017, "ScheduleObjectEmpty", "Schedule 对象为空", "schedule", False),
    302018: _e(
        302018, "ScheduleTypeConvertFailed", "参数类型转换失败", "schedule", False
    ),
    302019: _e(302019, "ScheduleDownstreamFailed", "调用下游失败", "schedule", True),
    302020: _e(
        302020, "ScheduleContentViolation", "日程内容违规、账号违规", "schedule", False
    ),
    302021: _e(
        302021, "ScheduleDailyGuildLimit", "频道内当日新增活动达上限", "schedule", False
    ),
    302022: _e(
        302022,
        "ScheduleBindWrongChannel",
        "不能绑定非当前频道的子频道",
        "schedule",
        False,
    ),
    302023: _e(
        302023,
        "ScheduleBindForbiddenOnJump",
        "开始时跳转不可绑定日程子频道",
        "schedule",
        False,
    ),
    302024: _e(
        302024, "ScheduleBoundChannelMissing", "绑定的子频道不存在", "schedule", False
    ),
    ...
    304035: _e(
        304035, "PUSH_CHANNEL_LIMIT", "推送消息超过子频道数量限制", "rate_limit", False
    ),
    304036: _e(
        304036,
        "NO_MARKDOWN_TEMPLATE_PERMISSION",
        "没有 markdown 模板权限",
        "permission",
        False,
    ),
    ...
    304039: _e(
        304039, "KEYBOARD_PARSE_ERROR", "消息按钮组件解析错误", "request", False
    ),
    304040: _e(
        304040, "KEYBOARD_CONTENT_ERROR", "消息按钮组件消息内容错误", "request", False
    ),
    304044: _e(304044, "GET_MESSAGE_SETTING_ERROR", "取消息设置错误", "platform", True),
    304045: _e(
        304045, "CHANNEL_PUSH_LIMIT", "子频道主动消息数限频", "rate_limit", False
    ),
    304046: _e(
        304046,
        "CHANNEL_PUSH_FORBIDDEN",
        "不允许在此子频道发主动消息",
        "permission",
        False,
    ),
    304047: _e(
        304047,
        "GUILD_PUSH_CHANNEL_LIMIT",
        "主动消息推送超过限制的子频道数",
        "rate_limit",
        False,
    ),
    304048: _e(
        304048, "GUILD_PUSH_FORBIDDEN", "不允许在此频道发主动消息", "permission", False
    ),
    304049: _e(304049, "DM_PUSH_LIMIT", "私信主动消息数限频", "rate_limit", False),
    304050: _e(
        304050, "DM_PUSH_TOTAL_LIMIT", "私信主动消息总量限频", "rate_limit", False
    ),
    304051: _e(
        304051,
        "GUIDE_REQUEST_BUILD_ERROR",
        "消息设置引导请求构造错误",
        "request",
        False,
    ),
    ...
    306001: _e(
        306001, "DeleteMessageParamInvalid", "撤回消息参数错误", "delete_message", False
    ),
    306002: _e(306002, "DeleteMessageIdError", "消息 id 错误", "delete_message", False),
    306003: _e(
        306003, "DeleteGetMessageFailed", "获取消息错误", "delete_message", True
    ),
    306004: _e(
        306004,
    ...
    306006: _e(
        306006, "DeleteGetChannelFailed", "获取子频道失败", "delete_message", True
    ),
    306007: _e(306007, "DeleteWrongGroup", "非当前群的消息", "delete_message", False),
    306008: _e(
        306008,
        "DeleteNotOwnBotMessage",
        "非当前机器人发送的消息",
        "delete_message",
        False,
    ),
    ...
    306011: _e(
        306011, "DeleteMessageExpired", "超出可撤回消息时间", "delete_message", False
    ),
    501001: _e(501001, "AnnouncementParamInvalid", "参数校验失败", "announce", False),
    501002: _e(
        501002,
        "AnnouncementChannelCreateFailed",
        "创建子频道公告失败",
        "announce",
        True,
    ),
    501003: _e(
        501003,
        "AnnouncementChannelDeleteFailed",
        "删除子频道公告失败",
        "announce",
        True,
    ),
    501004: _e(
        501004, "AnnouncementGetGuildFailed", "获取频道信息失败", "announce", True
    ),
    501005: _e(
        501005, "AnnouncementMessageIdError", "MessageID 错误", "announce", False
    ),
    501006: _e(
        501006,
        "AnnouncementGuildCreateFailed",
        "创建频道全局公告失败",
        "announce",
        True,
    ),
    501007: _e(
        501007,
        "AnnouncementGuildDeleteFailed",
        "删除频道全局公告失败",
        "announce",
        True,
    ),
    501008: _e(
        501008, "AnnouncementMessageIdMissing", "MessageID 不存在", "announce", False
    ),
    501009: _e(
        501009,
        "AnnouncementMessageIdParseFailed",
        "MessageID 解析失败",
        "announce",
        False,
    ),
    ...
    501018: _e(
        501018, "RecommendChannelInvalid", "推荐子频道 ID 无效", "announce", False
    ),
    501019: _e(501019, "AnnouncementTypeError", "公告类型错误", "announce", False),
    501020: _e(
        501020,
        "RecommendChannelAnnouncementCreateFailed",
        "创建推荐子频道类型频道公告失败",
        "announce",
        True,
    ),
    ...
    503010: _e(
        503010, "ForumTinyIdConvertFailed", "通过Uin获取TinyID失败", "forum", True
    ),
    503011: _e(
        503011, "ForumTimestampInvalid", "帖子ID时间戳无效或不合法", "forum", False
    ),
    ...
    504001: _e(
        504001, "RateLimitParamInvalid", "请求参数无效错误", "rate_limit", False
    ),
    504002: _e(
        504002, "RateLimitGetHeaderFailed", "获取 HTTP 头失败", "rate_limit", True
    ),
    504003: _e(
        504003, "RateLimitGetBotUinFailed", "获取 BOT UIN 错误", "rate_limit", True
    ),
    504004: _e(
        504004,
        "RateLimitSettingsFailed",
        "获取消息频率设置信息错误",
        "rate_limit",
        True,
    ),
    ...
    610003: _e(
        610003,
        "APIPermissionGetBotNumberFailed",
        "获取机器人号码失败",
        "guild_permission",
        True,
    ),
    ...
    610005: _e(
        610005,
        "APIPermissionGetBotRoleInternalError",
        "获取机器人角色内部错误",
        "guild_permission",
        True,
    ),
    ...
    610008: _e(
        610008, "APIPermissionInvalidParam", "无效参数", "guild_permission", False
    ),
    610009: _e(
        610009,
        "APIPermissionDetailFailed",
        "获取 API 接口详情失败",
        "guild_permission",
        True,
    ),
    ...
    610011: _e(
        610011,
        "APIPermissionBotInfoFailed",
        "获取机器人信息失败",
        "guild_permission",
        True,
    ),
    610012: _e(
        610012, "APIPermissionRateLimitFailed", "限频失败", "guild_permission", True
    ),
    610013: _e(610013, "APIPermissionRateLimited", "已限频", "guild_permission", True),
    610014: _e(
        610014,
        "APIPermissionLinkSendFailed",
        "api 授权链接发送失败",
        "guild_permission",
        True,
    ),
    ...
    630005: _e(
        630005,
        "InteractionDataStoreReadFailed",
        "互动回调数据更新内部存储读取错误",
        "interaction",
        True,
    ),
    630006: _e(
        630006,
        "InteractionDataRequestAppIdFailed",
        "互动回调数据更新读取请求AppID失败",
        "interaction",
        True,
    ),
    630007: _e(
        630007, "InteractionDataTooLarge", "互动回调数据太大", "interaction", False
    ),
    1100100: _e(1100100, "SAFE_RATE_LIMIT", "安全打击：消息被限频", "rate_limit", True),
    1100101: _e(1100101, "SAFE_SENSITIVE", "安全打击：内容涉及敏感", "safety", False),
    1100102: _e(
        1100102, "SAFE_NOT_ELIGIBLE", "暂未获得新功能体验资格", "permission", False
    ),
    1100103: _e(1100103, "SAFE_BLOCK", "安全打击", "safety", False),
    1100104: _e(
        1100104, "GROUP_INVALID", "该群已失效或当前群已不存在", "resource", False
    ),
    1100300: _e(1100300, "INTERNAL_ERROR", "系统内部错误", "platform", True),
    1100301: _e(
        1100301, "CALLER_NOT_GROUP_MEMBER", "调用方不是群成员", "permission", False
    ),
    1100302: _e(
        1100302, "GET_CHANNEL_NAME_FAILED", "获取指定频道名称失败", "platform", True
    ),
    1100303: _e(
        1100303,
        "NON_ADMIN_CANNOT_SPEAK",
        "主页频道非管理员不允许发消息",
        "permission",
        False,
    ),
    ...
    1100305: _e(
        1100305, "TINYID_TO_UIN_FAILED", "TinyId 转换 Uin 失败", "platform", True
    ),
    1100306: _e(
        1100306, "NOT_PRIVATE_GUILD_MEMBER", "非私有频道成员", "permission", False
    ),
    1100307: _e(
        1100307, "NOT_WHITELIST_CHANNEL_APP", "非白名单应用子频道", "permission", False
    ),
...
def build_openapi_error(
    ...
    *,
    ...
    error_message = (
        default_message or response.reason or http_status_description(response.status)
    )
