...
| [`packages/bub-searxng-search`](./packages/bub-searxng-search/README.md)             |                                                                                                           | Provides a `searxng.search` tool backed by a self-hosted SearXNG instance. Registers the tool only when `BUB_SEARXNG_SEARCH_BASE_URL` is configured. |
| [`packages/bub-web-search`](./packages/bub-web-search/README.md)                     |                                                                                                           | Provides a `web.search` tool backed by the Ollama web search API. Registers the tool only when `BUB_SEARCH_OLLAMA_API_KEY` is configured.            |
