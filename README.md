...
| [`bub-agent-plugins`](./packages/bub-agent-plugins/README.md)               |                                                                                                           | Loads portable Agent Plugins 1.0 skills and MCP servers through Bub's existing skill parser and `bub-mcp` runtime.                    |
