...
| ------------------------------------------------------------------------------------ | ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`packages/bub-acp`](./packages/bub-acp/README.md)                                   | `acp`                  | Runs Bub as an ACP server and bridges external ACP agents into Bub through the `run_model` and `run_model_stream` hooks.                           |
